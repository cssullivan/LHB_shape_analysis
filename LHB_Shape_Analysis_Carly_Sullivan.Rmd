---
title: "R-Wizardry Final Project Carly Mattis"
author: "Carly Mattis"
date: "11/06/2019"
...
```{r}
forelimb.shape.data <- read.csv("experimental_FL_nohets.csv")  #read the csv data file that I sent to you with landmark data 
hindlimb.shape.data <- read.csv("experimental_HL_nohets.csv")
skull.shape.data <- read.csv("experimental_S_nohets.csv")
